<template>
  <q-page class="q-pa-md">
    ...
    <!-- PopUp para crear y editar registros -->
        ...
        <q-card-section>
          ...
          <q-row class="q-gutter-md">
            ...
            <q-col :cols="12" :md="6">
              ...
              <q-select v-model="currentItem.estado" label="En Desarrollo" :options="enDesarrollo" option-value="id"
              ...
              <!--q-input v-model="currentItem.estado" label="En Desarrollo" outlined /-->
            </q-col>
          </q-row>
        </q-card-section>
